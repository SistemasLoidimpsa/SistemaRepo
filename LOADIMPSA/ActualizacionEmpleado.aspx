<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Menu.Master"  CodeBehind="ActualizacionEmpleado.aspx.cs" Inherits="LOADIMPSA.ActualizacionEmpleado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel runat="server" ID="uppActualizacionEmpleado">
        <ContentTemplate>
            <link rel="Stylesheet" href="css/TabStyles.css" type="text/css" media="screen" />
            <table style="width: 100%">
                <tr>
                    <td style="text-align: center" colspan="5">
                        <asp:Label ID="Label1" runat="server" Text="ACTUALIZACIÓN DE DATOS EMPLEADO" CssClass="tituloHeader" ForeColor="#1D4289"></asp:Label>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="5" style="text-align: center; margin-left: auto; margin-right: auto">
                        <asp:Panel ID="pnlAdministracion" Width="100%" runat="server" DefaultButton="btnBuscar" HorizontalAlign="Center">
                            <br />
                            <asp:TextBox ID="txtEmpleadoBuscar" runat="server" Visible="true" CssClass="textboxNormal" placaholder=" Identificación - Nombres" BorderColor="Black"></asp:TextBox>
                            &nbsp;&nbsp; &nbsp;&nbsp;
                    ...
                    <td colspan="4">
                        ...
                        <asp:Panel ID="pnlClientes" runat="server" Width="50%" HorizontalAlign="Center" Style="margin-left: auto; margin-right: auto">
                            <asp:GridView ID="gvEmpleados" runat="server" AutoGenerateColumns="False"
                                ...
                                BorderWidth="1px" CellPadding="3" OnSelectedIndexChanged="gvEmpleados_SelectedIndexChanged">
                                <Columns>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 33%; margin-left: auto; margin-right: auto">
                            ...
                            <asp:DropDownList ID="ddlRol" class="textboxNormal" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlRol_SelectedIndexChanged" CssClass="form-control" Width="80%">
                                <asp:ListItem Text="Super Administrador" Value="1" Enabled="false"></asp:ListItem>
                                <asp:ListItem Text="Ejecutivo de Cuenta" Value="2"></asp:ListItem>
                                <asp:ListItem Text="Administrador" Value="4"></asp:ListItem>
                                <asp:ListItem Text="Operaciones" Value="6"></asp:ListItem>
                                <asp:ListItem Text="Operaciones Despacho" Value="8"></asp:ListItem>
                                <asp:ListItem Text="Servicio al Cliente" Value="9"></asp:ListItem>
                            </asp:DropDownList>
                            <br />
