<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RespAprobada.aspx.cs" Inherits="LOADIMPSA.respAprobada" %>
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <div id="main">
                    <h1><span class="ja">¡EXCELENTE!</span>      </h1>             
                    <br>
                    <p align="justify">El pago se ha relizado con éxito, regresar a la pestaña Mis Envios y dar click en el boton  "Verificar Pago", para generar su Orden.</p>
                    <br><p align="center">Gracias por confiar en LOIDIMPSA EXPRESS! .</p>
